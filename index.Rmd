...
For the fitted Random Forest model the OOB estimate of  error rate: 5.44% and a  `r round(sum(predictedWithRF==trainingSet$classe)/nrow(trainingSet),2)*100` % accuracy on the training set.
